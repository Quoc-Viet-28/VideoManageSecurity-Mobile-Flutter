...
TextStyle styleS14W3(Color? color) => TextStyle(
    fontSize: 14, fontWeight: FontWeight.w300, color: color ?? textPrimary);
...
TextStyle styleS18W7(Color? color) => TextStyle(
    fontSize: 18, fontWeight: FontWeight.w700, color: color ?? textPrimary);
...
TextStyle styleS20W7(Color? color) => TextStyle(
    fontSize: 20, fontWeight: FontWeight.w700, color: color ?? textPrimary);
...
TextStyle styleS24W7(Color? color) => TextStyle(
    fontSize: 24, fontWeight: FontWeight.w700, color: color ?? textPrimary);

TextStyle styleS32W7(Color? color) => TextStyle(
    fontSize: 32, fontWeight: FontWeight.w700, color: color ?? textPrimary);
